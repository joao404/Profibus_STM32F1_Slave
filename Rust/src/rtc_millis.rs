...
/**
  ...
  A continuously running clock that counts milliseconds¹. It is part of the backup domain which means
...
impl Rtc<RtcClkLse> {
    ...
    */
    pub fn new(regs: RTC, bkp: &mut BackupDomain) -> Self {
        ...
        // Set the prescaler to make it count up once every milli second.
        let prl = LSE_HERTZ.raw() / 1000 - 1;
        assert!(prl < 1 << 20);
